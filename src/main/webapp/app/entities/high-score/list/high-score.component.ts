...
import { EntityArrayResponseType, HighScoreService } from '../service/high-score.service';
...
export class HighScoreComponent implements OnInit {
  ...
  trackId = (_index: number, item: IHighScore): number => this.highScoreService.getHighScoreIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.highScores = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IHighScore[] | null): IHighScore[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.highScoreService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
