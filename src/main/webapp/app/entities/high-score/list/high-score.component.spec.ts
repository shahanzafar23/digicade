...
describe('HighScore Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'high-score', component: HighScoreComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.highScores?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to highScoreService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getHighScoreIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getHighScoreIdentifier).toHaveBeenCalledWith(entity);
